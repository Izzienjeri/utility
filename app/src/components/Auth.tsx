...
const Auth: React.FC<AuthProps> = ({ initialRoute }) => {
  ...
  const renderLoginForm = () => (
    <motion.div
      className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#E2D7E3] via-[#BCAFBD] to-[#E9ADBC]"
    ...
    >
      <motion.div 
        className="w-full max-w-md bg-white backdrop-blur-lg bg-opacity-90 rounded-3xl shadow-2xl overflow-hidden"
      ...
      >
        ...
        <div className="px-8 pt-8 pb-10">
          ...
          >
            ...
            <p className="text-[#BCAFBD] mt-2 text-center text-sm">Sign in to access your account</p>
          </motion.div>
          ...
          <form onSubmit={handleLogin}>
            <motion.div className="mb-6" variants={itemVariants}>
              <label className="block text-[#BCAFBD] text-sm font-medium mb-2" htmlFor="email">
                <Mail className="inline-block mr-2 align-middle" size={16} />
                <span className="align-middle">Email Address</span>
              </label>
              <div className="relative">
                <input
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#E9ADBC] focus:border-transparent transition-all duration-200 outline-none text-sm"
                  id="email"
                  type="email"
            ...
            <motion.div className="mb-8" variants={itemVariants}>
              <label className="block text-[#BCAFBD] text-sm font-medium mb-2" htmlFor="password">
                <Lock className="inline-block mr-2 align-middle" size={16} />
            ...
            <motion.div className="flex items-center justify-between" variants={itemVariants}>
              <motion.button
                className="w-full bg-gradient-to-r from-[#E9ADBC] to-[#E17295] text-white font-medium py-3 px-6 rounded-xl flex items-center justify-center shadow-lg shadow-pink-200/50 hover:shadow-pink-300/50 transition-all duration-300 text-sm"
                type="submit"
          ...
          <motion.div 
            ...
            variants={itemVariants}
          >
            <p className="text-[#BCAFBD] text-sm">
        ...
        >
          ...
          <div className="px-8 pt-8 pb-10">
            ...
            >
              ...
              <p className="text-[#BCAFBD] mt-2 text-center text-sm">Join us today!</p>
            </motion.div>
            ...
            <form onSubmit={handleRegister}>
              <motion.div className="mb-4" variants={itemVariants}>
                <label className="block text-[#BCAFBD] text-sm font-medium mb-2" htmlFor="fullName">
                  <UserPlus className="inline-block mr-2 align-middle" size={16} />
                  <span className="align-middle">Full Name</span>
                </label>
                <input
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#E9ADBC] focus:border-transparent transition-all duration-200 outline-none text-sm"
                  id="fullName"
              ...
              <motion.div className="mb-4" variants={itemVariants}>
                <label className="block text-[#BCAFBD] text-sm font-medium mb-2" htmlFor="phone">
                  <Phone className="inline-block mr-2 align-middle" size={16} />
  ...
  const renderDashboard = () => (
    <motion.div
      className="min-h-screen bg-gradient-to-br from-[#E2D7E3] via-[#BCAFBD] to-[#E9ADBC]"
      variants={containerVariants}
      initial="hidden"
      animate="visible"
      exit="exit"
        ...
        >
          ...
          <div className="px-8 py-12">
            ...
            >
              ...
              <p className="text-[#BCAFBD] text-center max-w-md text-sm">You've successfully logged in. This is your personal dashboard where you can manage your account.</p>
            </motion.div>
            ...
            >
              {[1, 2, 3].map((item) => (
                ...
                >
                  ...
                  <p className="text-[#BCAFBD] text-sm">This is a placeholder for your dashboard content. Add your custom components here.</p>
                </motion.div>
              ))}
            </motion.div>
            ...
            >
              <motion.button
                ...
                className="bg-gradient-to-r from-[#E9ADBC] to-[#E17295] text-white font-medium py-3 px-8 rounded-xl flex items-center justify-center shadow-lg shadow-pink-200/50 hover:shadow-pink-300/50 transition-all duration-300 text-sm"
                variants={buttonVariants}
                whileHover="hover"
                whileTap="tap"
              >
